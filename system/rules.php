		...
		<div class="row">
			...
			<div class="col-md-2">
				 <div class="list-group">
				 	<a href="rules.php" class="list-group-item active">查询计算规则</a>
				 	<a href="rules_change.php" class="list-group-item">修改计算规则</a>
				 </div>
			</div>
			<!-- 右侧列表 -->
			<div class="col-md-10">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="rules.php">查询计算规则</a></li>
					<li><a href="rules_change.php">修改计算规则</a></li>
				</ul>
				<h3>计算规则查询</h3>
