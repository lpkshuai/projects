		...
		<div class="row">
			...
			<div class="col-md-2">
				 <div class="list-group">
				 	<a href="content.php" class="list-group-item">按教师个人</a>
				 	<a href="content_major.php" class="list-group-item active">按教学单位</a>
			...
			<div class="col-md-10">
				...
				<ul class="nav nav-tabs">
					<li><a href="content.php">按教师个人</a></li>
					<li class="active"><a href="content_major.php">按教学单位</a></li>
