		...
		<div class="row">
			...
			<div class="col-md-2">
				 <div class="list-group">
				 	<a href="other.php" class="list-group-item active">教师信息管理</a>
				 	<a role="button" class="list-group-item" data-toggle="modal" data-target="#myModal">添加教师</a>
				 	<a href="lab.php" class="list-group-item">机房管理</a>
			...
			<div class="col-md-10">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a href="other.php">教师信息管理</a></li>
					<li><a role="button" data-toggle="modal" data-target="#myModal">添加教师</a></li>
					<li><a href="lab.php">机房管理</a></li>
					<li><a role="button" data-toggle="modal" data-target="#myModal2">添加机房</a></li>
				</ul>
					...
					<tbody>
						<?php
							...
							while($row = mysqli_fetch_assoc($result)){
							    ...
							    <td>
EOD;
								echo '<a class="btn btn-primary" href="teacher_del.php?tno='.$row['tno'].'">删除</a>';
								echo '</td>';
							 }
						?>
					</tbody>
